...
import 'package:flutter_animations/components/sprite_weather_button.dart';
...
class SpriteWeatherPage extends StatefulWidget {
  static const String id = '/weather';
  @override
  _SpriteWeatherPageState createState() => _SpriteWeatherPageState();
}

class _SpriteWeatherPageState extends State<SpriteWeatherPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: Text('Sprite')),
      body: Material(
        child: Stack(
          children: <Widget>[
...
class SpriteWorld extends NodeWithSize {
  SpriteWorld() : super(const Size(2048.0, 2048.0)) {
    // Start by adding a background.
    _background = new GradientNode(
      this.size,
      kBackgroundColorsTop[0],
      kBackgroundColorsBottom[0],
    );
  ...
  set weatherType(WeatherType weatherType) {
    ...
    _background.motions.run(new MotionTween<Color>(
        ...
        kBackgroundColorsTop[weatherType.index],
        1.0));

    _background.motions.run(new MotionTween<Color>(
        (a) => _background.colorBottom = a,
        _background.colorBottom,
        kBackgroundColorsBottom[weatherType.index],
        1.0));
